...
@Component({
  selector: 'app-dafina-kastrati',
  standalone: true,
  templateUrl: './dafina-kastrati.component.html',
  styleUrls: ['./dafina-kastrati.component.css'],
})
export class DafinaKastratiComponent implements OnInit {
  /**
  ...
  ngOnInit(): void {
     ...
     *  - https://rxmarbles.com/
     */
    this.aboutService.getDafinaKastratiInfo().subscribe({
      // Unser Wert kam erfolgreich an!
      next: (val) => {
        this.nameInfo = val;
      },
