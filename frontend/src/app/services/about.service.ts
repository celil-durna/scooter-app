...
export class AboutService {
   ...
   */
  public getDafinaKastratiInfo(): Observable<NameInfo> {
   return this.http.get<NameInfo>('api/dafina-kastrati');
  }

  public getJonasHeiligInfo(): Observable<NameInfo> {
    return this.http.get<NameInfo>('api/jonas-heilig');
  }

  public getNaserThaqiInfo(): Observable<NameInfo> {
    return this.http.get<NameInfo>('api/naser-thaqi');
  }

  public getCelilDurnaInfo(): Observable<NameInfo> {
   return this.http.get<NameInfo>('api/celil-durna');
  }

  public getMojtabaMalekNejadInfo(): Observable<NameInfo> {
   return this.http.get<NameInfo>('/api/mojtaba-maleknejad');
  }

  public getMichaelHuberInfo(): Observable<NameInfo> {
    return this.http.get<NameInfo>('api/michael-huber');
  }
